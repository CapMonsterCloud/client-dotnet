...
public static class ObjectGen
{
    ...
    public static CaptchaResult<RecaptchaV3EnterpriseResponse> CreateSolution()
    {
        return new CaptchaResult<RecaptchaV3EnterpriseResponse>
        {
            Error = null,
            Solution = new RecaptchaV3EnterpriseResponse
            {
                Value = Gen.RandomString(),
            }
        };
