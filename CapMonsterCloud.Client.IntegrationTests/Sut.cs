...
public class Sut
{
    ...
    public async Task<CaptchaResult<RecaptchaV3EnterpriseResponse>> SolveAsync(
        ...
        List<object> expectedResponses)
    {
        ...
        {
            part.ReturnsResponse(HttpStatusCode.OK, new StringContent(CapMonsterCloudClient.ToJson(item)));
        }
    }
